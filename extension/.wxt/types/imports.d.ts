...
declare global {
  ...
  const useApi: typeof import('C:/Users/shour/Downloads/shopii/extension/hooks/useApi').useApi
  const useAppConfig: typeof import('wxt/utils/app-config').useAppConfig
  const useAuth: typeof import('C:/Users/shour/Downloads/shopii/extension/hooks/useAuth').useAuth
  const useCallback: typeof import('react').useCallback
  const useContext: typeof import('react').useContext
  const useEffect: typeof import('react').useEffect
  const useMemo: typeof import('react').useMemo
  const usePaginatedApi: typeof import('C:/Users/shour/Downloads/shopii/extension/hooks/useApi').usePaginatedApi
