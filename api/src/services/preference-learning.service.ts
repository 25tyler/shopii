  ...
  try {
    ...
    if (!prefs) {
      ...
      await prisma.userPreferences.create({
        data: {
          userId,
          learnedCategories: formatJson([]) as any,
          learnedBrands: formatJson([]) as any,
          recentSearches: formatArray([]) as any,
        },
      });
    ...
    await prisma.userPreferences.update({
      where: { userId },
      data: {
        learnedCategories: formatJson(learnedCategories) as any,
        learnedBrands: formatJson(learnedBrands) as any,
        recentSearches: formatArray(recentSearches) as any,
      },
    });
